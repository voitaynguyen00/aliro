...
#  define ALIRO_LOG_DEBUG(fmt, ...) \
       ::aliro::log::dispatch(::aliro::log::Level::DEBUG, __FILE__, __LINE__, fmt __VA_OPT__(,) __VA_ARGS__)
#  define ALIRO_LOG_INFO(fmt, ...)  \
       ::aliro::log::dispatch(::aliro::log::Level::INFO,  __FILE__, __LINE__, fmt __VA_OPT__(,) __VA_ARGS__)
#  define ALIRO_LOG_WARN(fmt, ...)  \
       ::aliro::log::dispatch(::aliro::log::Level::WARN,  __FILE__, __LINE__, fmt __VA_OPT__(,) __VA_ARGS__)
#  define ALIRO_LOG_ERROR(fmt, ...) \
       ::aliro::log::dispatch(::aliro::log::Level::ERROR, __FILE__, __LINE__, fmt __VA_OPT__(,) __VA_ARGS__)
#endif
